...
// async function fetchRegularData(cals, numMeals, carbs, protein, fat) {
...
// export async function fetchRegular(cals, numMeals, carbs = 0, protein = 0, fat = 0) {
//     return fetchRegularData(cals, numMeals, carbs, protein, fat)
//         .then(d => {
//             const mainData = d[0].data.results;

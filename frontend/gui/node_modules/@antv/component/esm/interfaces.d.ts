...
export interface IList {
     ...
     */
    setItems(items: ListItem[]): any;
    /**
     * 更新列表项
     * @param {ListItem} item 列表项
     * @param {object}   cfg  列表项
     */
    updateItem(item: ListItem, cfg: object): any;
    /**
     * 清空列表
     */
    clearItems(): any;
     ...
     */
    setItemState(item: ListItem, state: string, value: boolean): any;
    /**
     * 根据状态获取
     ...
     */
    clearItemsState(state: string): any;
}
export interface ISlider {
     ...
     */
    setValue(value: number | number[]): any;
    /**
     * 获取当前值
...
export interface ILocation<T extends LocationCfg = LocationCfg> {
     ...
     * @param {T} cfg 定位信息
     */
    setLocation(cfg: T): any;
    /**
     * 设置偏移量
     * @param {number} offsetX 偏移 x
     * @param {number} offsetY 偏移 y
     */
    setOffset(offsetX: number, offsetY: number): any;
    /**
     * 获取偏移信息

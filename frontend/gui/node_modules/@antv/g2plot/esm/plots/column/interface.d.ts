...
import { TextStyle, Label, GraphicStyle, ICatAxis, IValueAxis, ISliderInteractionConfig, IScrollbarInteractionConfig } from '../../interface/config';
...
export declare type ColumnInteraction = {
    type: 'slider';

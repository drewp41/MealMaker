...
var BarLabel = /** @class */ (function (_super) {
    ...
    BarLabel.prototype.getLabelItemAttrs = function (element, idx) {
        var _a = this.options, style = _a.style, formatter = _a.formatter;
        var shape = element.shape;
        var value = this.getValue(element);
        return deepMix({}, style, __assign(__assign({}, this.getPosition(element)), { text: formatter ? formatter(value, shape, idx) : value, fill: this.getTextFill(element), stroke: this.getTextStroke(element), textAlign: this.getTextAlign(element), textBaseline: this.getTextBaseline() }));
    };

...
import { TextStyle, Label, GraphicStyle, ICatAxis, IValueAxis, IInteractions, IScrollbarInteractionConfig } from '../../interface/config';
...
export declare type BarInteraction = {
    type: 'scrollBar';

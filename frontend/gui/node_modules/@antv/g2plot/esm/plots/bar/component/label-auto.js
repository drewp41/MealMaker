...
var BarAutoLabel = /** @class */ (function (_super) {
    ...
    BarAutoLabel.prototype.inShapeLabels = function (geometry, labels) {
        ...
        each(labels, function (label) {
            ...
            var fillWhile = isContrastColorWhite(shape.attr('fill'));
            ...
            if (labelBBox.width > shapeBBox.width) {
                ...
                if (overflow) {
                    ...
                    // 放置在柱形内部，颜色取反
                    label.attr({
                        fill: fillWhile ? lightStyle === null || lightStyle === void 0 ? void 0 : lightStyle.fill : darkStyle === null || darkStyle === void 0 ? void 0 : darkStyle.fill,
                        fillOpacity: fillWhile ? lightStyle === null || lightStyle === void 0 ? void 0 : lightStyle.fillOpacity : darkStyle === null || darkStyle === void 0 ? void 0 : darkStyle.fillOpacity,
                        stroke: undefined,
                    });
                }
            }

import { Label, LineStyle, TextStyle, GraphicStyle, ICatAxis, ITimeAxis, IValueAxis, ISliderInteractionConfig, IScrollbarInteractionConfig } from '../../interface/config';
...
export declare type IAreaLabel = IAreaPointLabel | IAreaPointAutoLabel | Label;
export declare type AreaInteraction = {
    type: 'slider';

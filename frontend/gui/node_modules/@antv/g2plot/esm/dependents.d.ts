...
export { Datum, Data, LooseObject, Options, Point, ShapeInfo, AttributeOption, AdjustOption, LabelOption, MappingDatum, } from '@antv/g2/lib/interface';
...
export declare const _ORIGIN = "_origin";

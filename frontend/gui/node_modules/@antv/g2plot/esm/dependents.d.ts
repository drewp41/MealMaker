...
export { View, registerAnimation, registerGeometry, Geometry, Interaction, registerInteraction, registerShape, getTheme, Util, getShapeFactory, } from '@antv/g2';
export { VIEW_LIFE_CIRCLE } from '@antv/g2/lib/constant';
export { Datum, Data, LooseObject, Options, Point, ShapeInfo, AttributeOption, AdjustOption, LabelOption, } from '@antv/g2/lib/interface';

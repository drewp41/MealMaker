...
var getValidSliderConfig = function (cfg) {
    if (cfg === void 0) { cfg = {}; }
    var _cfg = __assign({ type: 'horizontal', start: 0, end: 1, width: undefined, height: undefined, padding: [0, 0, 0, 0], backgroundStyle: undefined, foregroundStyle: undefined, handlerStyle: undefined, textStyle: undefined, trendCfg: undefined }, cfg);
    // default padding
    if (!cfg.padding) {
        _cfg.padding =

...
import { deepMix, isEmpty, mapValues, get, isUndefined, each, assign, isFunction, mix, map, flatten, reduce, findIndex, } from '@antv/util';
...
var ViewLayer = /** @class */ (function (_super) {
    ...
    ViewLayer.prototype.getOptions = function (props) {
        ...
        var interactions = reduce(flatten(map([options, defaultOptions, props], function (src) { return get(src, 'interactions', []); })), function (result, cur) {
        ...
        return deepMix({}, options, defaultOptions, props, { interactions: interactions });
    };
    ...
    ViewLayer.prototype.legend = function () {
        ...
        var flipOption = get(this.options, 'legend.flipPage');
        var clickable = get(this.options, 'legend.clickable');

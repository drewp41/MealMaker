...
function (_React$Component) {
  ...
  function ComboChart() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ComboChart)).call.apply(_getPrototypeOf2, [this].concat(args)));

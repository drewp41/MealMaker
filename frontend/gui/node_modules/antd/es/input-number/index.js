...
var InputNumber = /*#__PURE__*/function (_React$Component) {
  ...
  function InputNumber() {
    ...
    _this.renderInputNumber = function (_ref) {
      ...
      var upIcon = React.createElement(UpOutlined, {
        className: "".concat(prefixCls, "-handler-up-inner")
      });
      var downIcon = React.createElement(DownOutlined, {
      ...
      return React.createElement(SizeContext.Consumer, null, function (size) {
        ...
        var inputNumberClass = classNames((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-lg"), mergeSize === 'large'), _defineProperty(_classNames, "".concat(prefixCls, "-sm"), mergeSize === 'small'), _classNames), className);

  ...
  function DropdownButton() {
    ...
    _this.renderButton = function (_ref) {
      ...
      var _a = _this.props,
          ...
          href = _a.href,
          _a$icon = _a.icon,
          icon = _a$icon === void 0 ? React.createElement(EllipsisOutlined, null) : _a$icon,
          title = _a.title,
      ...
      var leftButton = React.createElement(Button, {
        type: type,
        disabled: disabled,
        onClick: onClick,
        htmlType: htmlType,
      ...
      var rightButton = React.createElement(Button, {
        type: type
      }, icon);
      ...
      }), leftButtonToRender, React.createElement(Dropdown, dropdownProps, rightButtonToRender));
    };
